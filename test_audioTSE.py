...
parser.add_argument('--output_dir', type=str, default='./test-audioTSE/')
...
parser.add_argument('--guidance_scale', type=float, default=2.5) # 2.5 for audio, 3.0 for text
...
parser.add_argument('--diffusion-ckpt', type=str, default='./pretrained_models/soloaudio_v2.pt') # change to your model path
